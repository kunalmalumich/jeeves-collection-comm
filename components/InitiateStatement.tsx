...
export default function InitiateStatement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Initiating statement conversation with data:", {
      customerPhone,
      month,
      amount,
      dueDate,
    ...
    try {
      ...
      const url = `${baseUrl}/api/initiate-statement`;
      ...
      setStatus(
        `Statement conversation initiated. Conversation SID: ${data.conversationSid}`,
      );
    } catch (error) {
